...
\subsection{Separate time courses for spatial and temporal predictability}
...
% * reference mathewson, van rullen, lakatos/schroeder, etc.
...
%%%
% * Low frequency oscillations convey information about spatial predictability
