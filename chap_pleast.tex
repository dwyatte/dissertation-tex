...
A total of five subjects were excluded from EEG analyses -- three for an overabundance of artifacts in the EEG recording resulting low trial counts after rejection and two for accuracy 2.7$\sigma$ (or further) below mean accuracy across subjects (these two subjects were also excluded from behavioral analyses, see preceding section). The remaining 24 subjects were included in all EEG analyses. 
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=140mm]{figs/pleast/results_entrain_tla_montage.pdf}
\end{center}
\caption{}{}
\label{fig:entrain}
\end{figure}
