...
% tf calculated over whole trial (including entrainment) and then cut up after, avoids boundary effects where timwin not long enough (http://mailman.science.ru.nl/pipermail/fieldtrip/2012-June/005346.html)
...
% Entrainers -- 10 Hz pow, ITC signify plots (space and time for both) -- unsurprising
%		interesting that space does not persist at 10 Hz, although time does
% Blank -- 10 Hz ITC for time only, no pow
