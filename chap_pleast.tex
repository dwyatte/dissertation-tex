...
\end{tabular}
\caption{Behavioral measures}{Accuracy, \textit{d'} (sensitivity), reaction time, and inverse efficiency (reaction time divided by percent correct) as a function of entrainment condition. S-/+ refers to spatially unpredictable and predictable, T-/+ to temporally unpredictable and predictable. Error bars depict standard error of the mean within subjects using the method described in \protect\incite{Cousineau05}.}
\label{fig:behave}
\end{figure}
