...
Event-related averaging was performed separately for the entraining sequence and the subsequent probe. For the entraining sequence, the data were baseline corrected 

% entrainer -- 50 ms before and after each stim
% probe -- 200 ms before and 400 after, pre-probe baseline
...
% entrainment figure, stats for -0.5 to 0.5 (i.e., average of entrainers 2-8)
% probe ERP with time bin significance -- use pretrial baseline, differential effects for space and time
% P1/N2 plot Nobre-like LeabraTI sse_sum_inv plots -- don't bother looking for synergistic effect, doesn't exist unless baselining to pre-probe blank, but even then, its tooooo smaaaallll

%% erp
%\begin{figure}[h!]
%\includegraphics[width=160mm]{figs/pleast/results_entrain_Oz_-50_prestim_baseline_int.pdf}
%\caption{}{}
%\label{fig:erp}
%\end{figure}
