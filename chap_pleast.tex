...
\end{center}
\caption{Delta-theta power before and after probe}{Delta-theta power 200 ms preceding the probe and 400 ms following. Dotted vertical line indicates probe onset. Gray shaded regions depict significant effects of spatial predictability (left), temporal predictability (center), and the interaction between these terms with gray shaded ranges while controlling for a maximum false discovery rate (FDR) of 5\%. Time axes indicate total trial time after the initial fixation cross.}
