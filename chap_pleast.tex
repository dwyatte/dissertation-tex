...
%			For discussion: better experiment would use a shorter blank (RANDY!) to get bonus effect of S+T+!
...
\end{center}
\caption{Effect of entrainer predictability on alpha power}{Alpha-band power over the entraining sequence. The top row depicts main effects of spatial and temporal predictability on oscillatory power in the 5-20 Hz frequency range. The bottom row depicts 10 Hz only effects of spatial predictability (left), temporal predictability (center), and the interaction between these terms with gray shaded ranges indicating significance while controlling for a maximum false discovery rate (FDR) of 5\%. Time axes indicate total trial time after the initial fixation cross with 0.4 seconds corresponding to the first entrainer.}
...
\end{center}
\caption{Effect of entrainer predictability on alpha phase coherence}{Alpha-band inter-trial coherence (ITC) over the entraining sequence. The top row depicts main effects of spatial and temporal predictability on ITC coherence in 5-20 Hz frequency range. The bottom row depicts 10 Hz only effects of spatial predictability (left), temporal predictability (center), and the interaction between these terms with gray shaded ranges indicating significance while controlling for a maximum false discovery rate (FDR) of 5\%. Time axes indicate total trial time after the initial fixation cross with 0.4 seconds corresponding to the first entrainer.}
\label{fig:entrain_ITC_10Hz}
\end{figure}

The effect of spatial predictability only persisted for three entrainers on average (duration ranges for 10 Hz power and ITC: 272-280 ms). Temporal predictability exhibited a sustained effect on 10 Hz power lasting nearly the entire entraining sequence. In the case of ITC, the effect of temporal predictability persisted throughout the blank period that separated the entraining sequence and the probe (Figure \ref{fig:probe_ITC_10Hz}). This result indicates that alpha phase remained aligned even without exogenous entrainment. No alpha-band effects were significant during the actual presentation of the actual probe, however.
...
\end{center}
\caption{Alpha phase coherence before and after probe}{Alpha-band inter-trial coherence (ITC) 200 ms preceding the probe and 400 ms following. Dotted vertical line indicates probe onset. Gray shaded ranges indicating significance while controlling for a maximum false discovery rate (FDR) of 5\%. Time axes indicate total trial time after the initial fixation cross.}
...
The effects of spatial and temporal predictability on alpha oscillatory properties during the probe itself were investigated in other frequency bands to determine 
...
\end{center}
\caption{Delta-theta power before and after probe}{Delta-theta power 200 ms preceding the probe and 400 ms following. Dotted vertical line indicates probe onset. The top row depicts main effects of spatial and temporal predictability on oscillatory power in the restricted 5-10 Hz frequency range to highlight differences. The bottom row depicts 5 Hz only effects of spatial predictability (left), temporal predictability (center), and the interaction between these terms with gray shaded ranges indicating significance while controlling for a maximum false discovery rate (FDR) of 5\%. Time axes indicate total trial time after the initial fixation cross.}
\label{fig:entrain_pow_5Hz}
\end{figure}
