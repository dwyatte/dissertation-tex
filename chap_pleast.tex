...
\end{tabular}
\end{center}
\caption{Behavioral effects of predictability on view interpolation and extrapolation.}{Accuracy, \textit{d'}, reaction time, and inverse efficiency as a function of entrainment condition. Magenta bars indicate view interpolation (i.e., angular difference between initial view and probe less than 168 degrees) and green bars view extrapolation (i.e., angular difference between initial view and probe greater than 168 degrees). Error bars depict within-subjects error using the method described in \protect\incite{Cousineau05} adapted for standard error.}
...
\subsection{Response enhancement for combined spatiotemporal prediction}
% TODO: Need to find an appropriate place to discuss DohertyRaoMesulamEtAl05 -- 100 ms bump for S+T+, definitely attention since it has been linked before
%
