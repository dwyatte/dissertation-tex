...
%		power increase by 3rd entrainer
...
Power and inter-trial coherence were computed... (Figures \ref{fig:pow_10Hz}-\ref{fig:ITC_10Hz})
...
\end{center}
\caption{Effect of entrainer predictability on alpha power}{}
\label{fig:pow_10Hz}
\end{figure}
...
\end{center}
\caption{Alpha phase coherence before and after probe}{}
\label{fig:ITC_10Hz}
\end{figure}
...
% model RT data with ITC or something
