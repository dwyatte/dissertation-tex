...
\begin{tabular}{ll}
\textbf{a)} \\
\includegraphics[width=100mm]{figs/srn_scm.png} \\
\textbf{b)} \\
\includegraphics[width=100mm]{figs/microcircuit_horiz.pdf} \\
\end{tabular}
...
\begin{tabular}{ll}
a) \hspace{76mm} b) \\
\multicolumn{2}{c}{\includegraphics[width=160mm]{figs/leabrati_comp.pdf}} \\
\end{tabular}
