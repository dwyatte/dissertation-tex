...
% each obj each cone
% spatial mania -- random
% temporal manip
% 	same obj up to 4 times, but decay weight scale -- same function as decaying acts themselves which is not possible in emergent
% record act_m

% test has minus and plus phase (need to load up those deep states) but no learning
