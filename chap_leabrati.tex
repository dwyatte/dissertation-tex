...
The overall computation of LeabraTI is shown in Figure \ref{fig:leabrati_comp} and summarized here. 

\textbf{TODO: New figure with actual amounts of time for minus/plus, with sensation first}
