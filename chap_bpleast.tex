...
% rot montage
\begin{figure}[h!]
\includegraphics[width=160mm]{figs/chap_bpleast/results_accuracy_rot_obj2_montage.pdf}
\caption{}{}
\label{fig:bpleast_behave_rot_montage}
\end{figure}
