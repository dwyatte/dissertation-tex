...
\end{tabular}
\end{center}
\caption{Accuracy as a function of viewing angle}{Error bars depict between-subjects standard error.}
...
\begin{center}
\begin{tabular}{ll}
\includegraphics[width=80mm]{figs/chap_bpleast/results_bootstrap_obj1.pdf} &
\includegraphics[width=80mm]{figs/chap_bpleast/results_bootstrap_obj2.pdf} \\
\includegraphics[width=80mm]{figs/chap_bpleast/results_bootstrap_obj3.pdf} &
\includegraphics[width=80mm]{figs/chap_bpleast/results_bootstrap_obj4.pdf} \\
\end{tabular}
\end{center}
\caption{}{}
