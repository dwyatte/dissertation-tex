...
\begin{center}
\begin{tabular}{ll}
\includegraphics[width=80mm]{figs/chap_bpleast/results_accuracy_obj1.pdf} &
\includegraphics[width=80mm]{figs/chap_bpleast/results_accuracy_obj2.pdf} \\
\includegraphics[width=80mm]{figs/chap_bpleast/results_accuracy_obj3.pdf} &
\includegraphics[width=80mm]{figs/chap_bpleast/results_accuracy_obj4.pdf} \\
\end{tabular}
\end{center}
\caption{}{X-axes denote target object and colors predictability during the training period. Error bars depict between-subjects standard error.}
\label{fig:bpleast_behave_obj}
\end{figure}
