...
\begin{tabular}{ll}
\textbf{A} \\
\includegraphics[width=160mm]{paperclip_rots.pdf} \\
\vspace{5mm} \\
\textbf{B} \\
\includegraphics[width=160mm]{paperclip_objs.pdf} \\
\end{tabular}
...
\begin{tabular}{ll}
\textbf{A} \\
\includegraphics[width=160mm]{paperclip_task.pdf} \\
\textbf{B} \hspace{90mm} \textbf{C} \\
\includegraphics[width=160mm]{paperclip_ISI.pdf} \\
\end{tabular}
...
\centering
\begin{tabular}{ll}
\includegraphics[width=80mm]{channels_oz.pdf} & 
\includegraphics[width=80mm]{channels_o1_o2.pdf} \\
\includegraphics[width=80mm]{channels_po3_po4.pdf} & 
\includegraphics[width=80mm]{channels_po7_po8.pdf} \\
\end{tabular}
